"""Doc and metadata tests for the v0.2.5 release."""
...
class TestV025ReleaseMetadata(unittest.TestCase):
    def test_pyproject_version_matches_v025_release(self) -> None:
        with PYPROJECT.open("rb") as handle:
            pyproject = tomllib.load(handle)

        self.assertEqual(pyproject["project"]["version"], "0.2.5")

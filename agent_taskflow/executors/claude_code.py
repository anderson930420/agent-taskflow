    ...
    *,
    ...
    return "\n".join(
        [
            ...
            "",
            "Validators and human review make every decision after implementation",
            "(see below), so this run stays out of them:",
            "",
            "- approval authority — you may not approve the task or set it to",
            "  waiting_approval or any approval state.",
